    ...
    >
      ...
      <motion.div variants={itemVariants} className="space-y-4">
        <motion.button
          ...
          className="w-full bauhaus-card p-6 hover:shadow-[6px_6px_0px_0px_var(--shadow-color)] bg-[var(--card-bg)] border-2 border-[var(--border-color)] rounded-none"
        >
        ...
        <div className="relative py-2">
          ...
          <div className="relative flex justify-center">
            <span className="px-4 text-foreground font-bold bg-background border-2 border-[var(--border-color)]">OR</span>
          </div>
        </div>
        ...
        <motion.button
          ...
          className="w-full bg-bauhaus-yellow border-2 border-[var(--border-color)] shadow-[4px_4px_0px_0px_var(--shadow-color)] hover:shadow-[6px_6px_0px_0px_var(--shadow-color)] p-6 transition-all rounded-none"
        >
          <div className="text-bauhaus-dark font-bold text-lg">Continue as Guest</div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="bauhaus-input w-full font-bold"
                    maxLength={20}
                    autoFocus
                  />
                  <p className="text-xs text-foreground/60 mt-2 font-medium">This is how you'll appear in the room</p>
                </div>
              </div>
